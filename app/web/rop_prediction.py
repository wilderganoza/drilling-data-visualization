...
import numpy as np
# Importamos pandas para armar y transformar las tablas de features de cada paso del wizard
import pandas as pd
...
# Importamos PCA/StandardScaler para las vistas previas de escalado y componentes principales
from sklearn.decomposition import PCA
from sklearn.preprocessing import StandardScaler
# Importamos Session para tipar la sesión de SQLAlchemy inyectada
from sqlalchemy.orm import Session
# Importamos FormData para tipar los datos de formulario que leemos en algunos pasos
...
from app.models.legacy import SensorWell as WellModel
...
# Importamos ENG_KEYS (las columnas de features calculadas) del servicio de features
from app.services.rop_features import ENG_KEYS
# Importamos las constantes del servicio de predicción bajo su nombre corto (además de "svc" arriba)
from app.services.rop_prediction import CONTROLLABLE, PLAUSIBLE_RANGES, TARGET
# Importamos los helpers de estadísticas/histograma que reutiliza el wizard desde outliers.py
