...
from app.models.legacy import User, SensorWell  # Modelos User y Well (pozo legacy con datos de sensores)
...
from app.web.shared import dataset_options, fetch_records, num as _num, parse_dataset_id, wells_for_domain  # Helpers compartidos entre vistas web
...
async def wells_page(
    ...
    # Consultamos los pozos que tienen datos de dominio tiempo
...
async def wells_open(
    ...
    well = db.query(SensorWell).filter(SensorWell.id == well_id).first()
