...
from app.repositories.well_repository import WellRepository  # Repositorio de pozos, usado por wells_for_domain
from app.db.session import db_manager  # Gestor de conexiones/tablas por dominio (depth/time)
from app.models.legacy import ProcessedDataset  # Modelo de dataset procesado, usado por dataset_options
