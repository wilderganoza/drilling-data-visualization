...
from app.web.shared import dataset_options, fetch_records, parse_dataset_id  # Helpers compartidos entre vistas web
...
async def quality_page(
    ...
    # Importamos db_manager aquí para saber si existen datos de dominio tiempo cargados
