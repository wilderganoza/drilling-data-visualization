...
# Importamos los repositorios de eventos y wellbores, para validar/mostrar contexto del evento padre
...
# Importamos el helper que arma la cadena de ancestros para pre-expandir el árbol lateral
