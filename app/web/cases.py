...
# Importamos la respuesta HTML para el fragmento renderizado tras borrar un caso
...
async def cases_page(current_user: User = Depends(get_current_user_web)):
    ...
    # Importamos la respuesta de redirección aquí porque solo la usa esta ruta
