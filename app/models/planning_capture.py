...
app/models/capture.py so a program column is declared in exactly one place."""
...
PLAN_CONFIGS: list[GridConfig] = [
    ...
    GridConfig(
        key="formation-tops", title="Formation Tops", table_name="plan_formation_tops",
    ...
    GridConfig(
        key="geopressure", title="Geopressure", table_name="plan_geopressure",
    ...
    GridConfig(
        key="casing-program", title="Casing Program", table_name="plan_casing",
    ...
    GridConfig(
        key="hole-program", title="Hole & Bit Program", table_name="plan_hole",
    ...
    GridConfig(
        key="mud-program", title="Mud Program", table_name="plan_mud",
    ...
    GridConfig(
        key="cement-program", title="Cement Program", table_name="plan_cement",
    ...
    GridConfig(
        key="directional-plan", title="Directional Plan", table_name="plan_directional",
    ...
    GridConfig(
        key="time-depth", title="Time–Depth Plan", table_name="plan_time_depth",
    ...
    GridConfig(
        key="cost-estimate", title="AFE Cost Estimate", table_name="plan_costs",
    ...
    GridConfig(
        key="risks", title="Risks & Hazards", table_name="plan_risks",
...
def _build_plan_model(cfg: GridConfig) -> type:
    ...
    attrs = {
        ...
        "__doc__": f"Well-plan program rows for '{cfg.title}'. See app/models/planning_capture.py.",
...
for _cfg in PLAN_CONFIGS:
    ...
    setattr(Event, f"plan_{_cfg.key.replace('-', '_')}_rows", relationship(_cfg.model, cascade="all, delete-orphan"))
